...
ANALYTICS_METADATA = {
    ...
    "in-dc_date": {"desc": "Planned or expected date the shipment should be at the Distribution Center (DC). Used to compare against actual delivery to check for plan deviations.", "type": "datetime"},
    "cargo_weight_kg": {
